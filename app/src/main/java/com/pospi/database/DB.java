...
public class DB extends SQLiteOpenHelper {
    ...
    public final String CREATE_Order_Table = "create table if not exists " + tableOrder + "("
            ...
            + ",orderNo text,miYaNumber text,orderSid text,vipId text)";
   ...
   /* //创建订单表
    ...
    public final String CREATE_Order_PayType = "create table order_paytype("
                        ...
                        + "payCode integer)";
    //创建促销时间表
    public final String CREATE_POP_TIME = "create table popTime("
            + "id integer primary key autoincrement, "
            + "sid integer, "//促销单的id
            + "detail text, "//促销单详情
            + "stime text,"//促销单起始日期
            ...
            + "etime text)";//促销单截至日期
    //创建快捷键表
    public final String CREATE_FAST = "create table fastChoose("
            + "id integer primary key autoincrement, "
            + "no text, "//编号
            + "name text)";//名称
    //创建店铺表
    public final String CREATE_SHOP = "create table shopMsg("
            + "id integer primary key autoincrement, "
            + "shopId text, "//
            + "name text, "//名称
            + "ad text, "//广告
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(CREATE_POP_TIME);
        db.execSQL(CREATE_FAST);
