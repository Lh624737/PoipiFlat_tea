...
//        tablayout.setTabMode(TabLayout.MODE_FIXED);
        ...
        for (String groupsid : groupsids) {
            ...
            mFragments.add(new ModifiedFragment(this, groupsid));
        }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.sure:
                ...
                bundle.putSerializable("modifieds", (Serializable) modifiedDtos);//
    ...
    @Override
    public void onFragmentClick(ModifiedDto modifiedDto) {
