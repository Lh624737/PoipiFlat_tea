...
public class DiscountDialogActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //退款false
        saleType = mIntent.getBooleanExtra("saleType", true);
...
//            }
    ...
    @OnClick({R.id.discount_zr, R.id.discount_zc, R.id.iv_jian, R.id.iv_jia, R.id.delete, R.id.discount_sure, R.id.cancle, R.id.sure,R.id.tv_setZp})
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.tv_setZp://设为赠品
                setZp();
                break;
