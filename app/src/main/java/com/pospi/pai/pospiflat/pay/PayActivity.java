...
//    private String miYaNumber = "";
    ...
    //混合支付指令数组
    private List<MyPay> pays = new ArrayList<>();

    private String sid_m;
    private EditText et_pay;
    private TextView tvWayName3;
    private TextView tvWayPrice3;
    private TextView tvWayName4;
    private TextView tvWayPrice4;
    private TextView sy;
...
//        Log.d("orderType", orderType + "");
        ...
        if (orderType == URL.ORDERTYPE_REFUND) {
            btn_pay.setText("退款");
            yingshou.setText(String.valueOf(-Double.parseDouble(value)));
            type = "2";
            tv_ys.setText("应退");
            tv_ss.setText("实退");
            tv_sy.setText("剩余退款金额:  ");
        } else {
    ...
    public void initWidgets() {
        ...
        tvWayName3 = (TextView) findViewById(R.id.pay_detail5);
        tvWayPrice3 = (TextView) findViewById(R.id.pay_detail6);
        tvWayName4 = (TextView) findViewById(R.id.pay_detail7);
        tvWayPrice4 = (TextView) findViewById(R.id.pay_detail8);
        sy = (TextView) findViewById(R.id.tv_syje);
        tv_sy = (TextView) findViewById(R.id.tv_sy);
        tv_ys = (TextView) findViewById(R.id.textView4);
        tv_ss = (TextView) findViewById(R.id.textView7);
        ...
        final PayWayDao payWayDao = new PayWayDao(PayActivity.this);
...
//                }
                ...
                switch (typeNumber) {
                    case 0:
                        firstChoose = py;
                        //现金，老年卡，储值卡，礼券
                        if (py == PayWay.CASH || py == PayWay.pay_lnk  || py == PayWay.MIANZHI_CARD || py == PayWay.CASH_GIFT ||py==PayWay.BANK_CARD) {
                            ...
                            if (mo >= yi) {
                                if (py == 1) {
                                    if (orderType == URL.ORDERTYPE_REFUND) {
                                        ...
                                        detail2.setText(DoubleSave.formatDouble(Double.parseDouble(show.getText().toString())));
                                    }
                                ...
                                zhaoling.setText(DoubleSave.formatDouble(s - yi) + "");
                                whatPay = py;
                                typeNumber = 5;
                                ...
                                detail2.setText(DoubleSave.formatDouble(Double.parseDouble(show.getText().toString())));
                                shishou.setText(detail2.getText().toString().trim());

                                typeNumber ++;
                            }
                            addPay(py,payWayDto.getName(),detail2.getText().toString());
...
//                                detail4.setText(DoubleSave.formatDouble(Double.parseDouble(yingshou.getText().toString()) - Double.parseDouble(detail2.getText().toString())));
//
//                            } else if (py == 1) {
                                detail3.setText(payWayDto.getName());
                                detail4.setText(DoubleSave.formatDouble(Double.parseDouble(show.getText().toString())));
//                            }
                            double y1 = Double.parseDouble(detail2.getText().toString());
                            double y2 = Double.parseDouble(detail4.getText().toString());

                            shishou.setText(DoubleSave.formatDouble(y1 + y2));
                            double y = Double.parseDouble(yingshou.getText().toString());

                            if (y1 + y2 >= y) {
                                zhaoling.setText(DoubleSave.formatDouble(y1 + y2 -y) + "");
                            } else {
                                zhaoling.setText("0.0");
                            }

                            addPay(py, payWayDto.getName(), detail4.getText().toString());
                            typeNumber ++;
                        } else {
...
//
//                            } else if (py == 1) {
                            tvWayName3.setText(payWayDto.getName());
                            tvWayPrice3.setText(DoubleSave.formatDouble(Double.parseDouble(show.getText().toString())));
//                            }
                            double y1 = Double.parseDouble(detail2.getText().toString());
                            double y2 = Double.parseDouble(detail4.getText().toString());
                            double y3 = Double.parseDouble(tvWayPrice3.getText().toString());

                            shishou.setText(DoubleSave.formatDouble(y1 + y2+y3));
                            double y = Double.parseDouble(yingshou.getText().toString());

                            if (y1 + y2 +y3>= y) {
                                zhaoling.setText(DoubleSave.formatDouble(y1 + y2 +y3-y) + "");
                            } else {
                                zhaoling.setText("0.0");
                            }

                            addPay(py, payWayDto.getName(), tvWayPrice3.getText().toString());
                            typeNumber ++;
                        } else {
                            Toast.makeText(PayActivity.this, "改付款方式不支持混合支付", Toast.LENGTH_SHORT).show();
                        }
...
//
//                            } else if (py == 1) {
                            tvWayName4.setText(payWayDto.getName());
                            tvWayPrice4.setText(DoubleSave.formatDouble(Double.parseDouble(show.getText().toString())));
//                            }
                            double y1 = Double.parseDouble(detail2.getText().toString());
                            double y2 = Double.parseDouble(detail4.getText().toString());
                            double y3 = Double.parseDouble(tvWayPrice3.getText().toString());
                            double y4 = Double.parseDouble(tvWayPrice4.getText().toString());
                            shishou.setText(DoubleSave.formatDouble(y1 + y2+y3+y4));
                            double y = Double.parseDouble(yingshou.getText().toString());

                            if (y1 + y2 +y3>= y) {
                                zhaoling.setText(DoubleSave.formatDouble(y1 + y2 +y3+y4-y) + "");
                            } else {
                                zhaoling.setText("0.0");
                            }

                            addPay(py, payWayDto.getName(), tvWayPrice4.getText().toString());
                            typeNumber ++;
                        } else {
                            Toast.makeText(PayActivity.this, "改付款方式不支持混合支付", Toast.LENGTH_SHORT).show();
                        }
...
//                }
    ...
    //判断是否存在已选择的支付方式
    public boolean isHasPay(int py){
        for (int i = 0; i < pays.size(); i++) {
            if (py == pays.get(i).getCode()) {
                return true;
            }
        }
        return false;
    ...
    public void addPay(int code, String name, String money) {
        MyPay myPay= new MyPay();
        myPay.setCode(code);
        myPay.setMoney(money);
        myPay.setName(name);
        pays.add(myPay);
    }
            ...
            case PayWay.CASH://现金
                if (!show.getText().toString().isEmpty()) {
                    if (Double.parseDouble(show.getText().toString()) >= Double.parseDouble(value)) {
                        ...
                        if (zl >= 0) {
                            zhaoling.setText(DoubleSave.formatDouble(zl));
                        }
                    } else {
...
//                            Log.i("payWayDtos", "点击银行卡了");
            ...
            case PayWay.E_COUPON://优惠券
                ...
                break;
            case PayWay.pay_lnk://老年卡
                    whatPay = PayWay.pay_lnk;
                    afterChoosePayWay(PayWay.LNK, value);
                break;
            case PayWay.pay_zp://支票
                    whatPay = PayWay.pay_zp;
                    afterChoosePayWay(PayWay.ZP, value);
                break;
            default:
                showToast("暂不支持此支付方式！");
                break;
...
//                    show.setText(DoubleSave.formatDouble(p2 - p1) + "");
//                } else {
//                    show.setText(value);
//                }
                show.setText(getShowMoney());
...
//        }
    ...
    public String getShowMoney(){
        ...
        double s = Double.parseDouble(shishou.getText().toString());
        if (s < y) {
            return DoubleSave.formatDouble(DoubleSave.doubleSaveTwo(y - s));
        }
        return "0.00";
    }
    ...
    public void pay() {
        ...
        if (canPay()) {
            if (pays.size() == 0||pays.size() == 1) {
                clickPay();
            } else if (pays.size() > 1) {//存在混合支付
            if (payList.size() != 0) {
                payList.clear();
             }
                StringBuilder builder = new StringBuilder();
                for (MyPay myPay : pays) {
                    Log.i("pay", myPay.getCode() +"--"+ myPay.getName() +"--"+ myPay.getMoney());
                    OrderPaytype paytype = new OrderPaytype();
                    paytype.setPayCode(myPay.getCode());
                    paytype.setPayName(myPay.getName());
                    paytype.setSs(myPay.getMoney());
                    paytype.setYs(myPay.getMoney());
                    payList.add(paytype);
                    builder.append(myPay.getName() + " ");
                }
                ...
                sendIntent(builder.toString(), shishou.getText().toString(), zhaoling.getText().toString());
            }
    ...
    public void clickPay() {
        switch (whatPay) {
            case PayWay.CASH:
                ...
                break;
            case PayWay.pay_zp://支票支付

                showFinshDialog(PayWay.ZP, PayWay.pay_zp, shishou.getText().toString(), true, null, null);
                print(shishou.getText().toString(), String.valueOf(PayWay.pay_zp));
                sendIntent(PayWay.ZP, shishou.getText().toString(), zhaoling.getText().toString());
                break;
            case PayWay.pay_lnk://老年卡

                showFinshDialog(PayWay.LNK, PayWay.pay_lnk, shishou.getText().toString(), true, null, null);
                print(shishou.getText().toString(), String.valueOf(PayWay.pay_lnk));
                sendIntent(PayWay.LNK, shishou.getText().toString(), zhaoling.getText().toString());
                break;
            case PayWay.WXPAY:
...
//                scanerCode("wx", PayWay.WX, PayWay.WXPAY);
                ...
                print(shishou.getText().toString(), String.valueOf(PayWay.WXPAY));
                sendIntent(PayWay.WX, shishou.getText().toString(), zhaoling.getText().toString());
                break;
            case PayWay.ALIPAY:
...
//                scanerCode("ali", PayWay.ZFB, PayWay.ALIPAY);
                ...
                print(shishou.getText().toString(), String.valueOf(PayWay.ALIPAY));
                sendIntent(PayWay.ZFB, shishou.getText().toString(), zhaoling.getText().toString());
                break;
            case PayWay.MIANZHI_CARD://储值卡
                if (Build.MODEL.equals(URL.MODEL_D800)) {
                    Intent intent = new Intent(PayActivity.this, ChuZhiKaDialogActivity.class);
                    ...
                    sendIntent(PayWay.CZK, shishou.getText().toString(), zhaoling.getText().toString());
//                    Toast.makeText(this, "不支持储值卡消费", Toast.LENGTH_SHORT).show();
                }
            ...
            case PayWay.BANK_CARD://银行卡
                ...
                sendIntent(PayWay.YHK, shishou.getText().toString(), zhaoling.getText().toString());
...
//        if (orderType == URL.ORDERTYPE_REFUND) {
//            shishou = String.valueOf(-Double.parseDouble(shishou));
//        }
        ...
        switch (Build.MODEL) {
            ...
            case URL.MODEL_DT92:
                ...
                break;
            case URL.MODEL_T1:
                myPrinter = PrinterFactory.getSuMiPrinter(PayActivity.this, maxNO, payway,sid_m);
                break;
        }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                for (int i = 0; i < receipt_num; i++) {
                    ...
                    myPrinter.starPrint(goods, shishou, null, true, valueCardDto, sid_m,orderType);
                }
            }
        }).start();
    }
...
//        chooseWay = true;
    ...
    public void showFinshDialog(final String payWay, int status, final String shishou,
        ...
        try {
            String vipId = getSharedPreferences("vipMsg", MODE_PRIVATE).getString("vipId", "");

            final String goods = getSharedPreferences("goodsdto_json", MODE_PRIVATE).getString("json", null);
            SharedPreferences  sp = getSharedPreferences("cashierMsg" ,MODE_PRIVATE);
            final String cashier_name = sp.getString("cashierName", "1000");

            final String shopId = getSharedPreferences("userMsg", MODE_PRIVATE).getString("uid", "");
...
//        String sid = GetData.getStringRandom(32);
            ...
            if (orderType == URL.ORDERTYPE_REFUND) {
                orderDto.setSs_money(String.valueOf(-Double.parseDouble(shishou)));
                orderDto.setYs_money(String.valueOf(-Double.parseDouble(yingshou.getText().toString())));
            } else {
...
//        orderDto.setOrderSid(sid);
            ...
            if (orderType == URL.ORDERTYPE_REFUND) {
                orderPaytype.setSs(String.valueOf(-Double.parseDouble(shishou)));
            } else {
                orderPaytype.setSs(shishou);
            }
            orderPaytype.setYs(value);
            if (zhaoling.getText().toString().equals("")) {
        ...
        //销毁vip信息
        SharedPreferences.Editor vipEdit = getSharedPreferences("vipMsg", MODE_PRIVATE).edit();
        vipEdit.clear();
        vipEdit.commit();
        //打开钱箱
        App.isAidl = true;
...
//                double y1 = Double.parseDouble(detail2.getText().toString());
            if (orderType == URL.ORDERTYPE_REFUND) {
                orderPaytype.setYs(DoubleSave.formatDouble(-DoubleSave.doubleSaveTwo(Double.parseDouble(paytypes.get(i).getYs()))));
                orderPaytype.setSs(DoubleSave.formatDouble(-DoubleSave.doubleSaveTwo(Double.parseDouble(paytypes.get(i).getSs()))));
            } else {
                orderPaytype.setYs(DoubleSave.formatDouble(DoubleSave.doubleSaveTwo(Double.parseDouble(paytypes.get(i).getYs()))));
                orderPaytype.setSs(DoubleSave.formatDouble(DoubleSave.doubleSaveTwo(Double.parseDouble(paytypes.get(i).getSs()))));
            }
...
//                orderPaytype.setYs(DoubleSave.formatDouble(y2 - y1) + "");
//                orderPaytype.setSs(DoubleSave.formatDouble(Double.parseDouble(detail4.getText().toString())));
//                if (zhaoling.getText().toString().equals("")) {
//                    orderPaytype.setZl("0.0");
//                } else {
//                    orderPaytype.setZl(zhaoling.getText().toString());
...
//        isRun = false;
        ...
        et_pay = (EditText) layout.findViewById(R.id.message);
        ...
        et_pay.setInputType(InputType.TYPE_NULL);
        ETRequestFocus();
        //扫码枪
        if (isChecked) {
            new Thread(new Runnable() {
         ...
         */
        et_pay.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            @Override
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                Log.i("action", "id="+actionId);
                if (actionId == KeyEvent.KEYCODE_UNKNOWN){
                    Toast.makeText(PayActivity.this, "支付码"+et_pay.getText().toString().trim().length()+"位：" + et_pay.getText().toString().trim(), Toast.LENGTH_SHORT).show();
...
//                showDialog("正在请求支付，请等待");
                ...
                scanerCode = et_pay.getText().toString().trim();
                            ...
                            scannerManager.scanStart(new ScannerListener() {
                                ...
                                public void scanOnRead(final ScanResult arg0) {
                                    if (arg0 != null) {
                                        ...
                                        et_pay.setText(arg0.getContent());
//                                        if (way.equals("ali")) {
//                                            payType = "3";
//                                        } else if (way.equals("wx")) {
//                                            payType = "1";
...
//                    final Scanner scanner = Scanner.getInstance(getApplicationContext());
//                    boolean flag = scanner.open(Scanner.Channel.CAMERA);
//                    Log.i(TAG, "scanner.open: " + flag);
//                    scanner.setOnScanListener(new Scanner.ScanListener() {
//                        @Override
//                        public void onRead(final String s) {
//                            if (s != null) {
//                                //requestPay(arg0.getContent(), way, wayName, status);
//                                Log.i(TAG, "scanCode: " + s);
//                                if (way.equals("ali")) {
//                                    payType = "3";
//                                } else if (way.equals("wx")) {
//                                    payType = "1";
...
//                                    @Override
//                                    public void run() {
//                                        boolean isSuccess = payToMiYa(saasid, s, shopId, jiju, opid, String.valueOf(maxNO), String.valueOf(Double.parseDouble(shishou.getText().toString()) * 100), payType, "");
//                                        if (way.equals("ali")) {
//                                            payType = "3";
//                                        } else if (way.equals("wx")) {
//                                            payType = "1";
...
//                    ScannerManager sm = ScannerManager.getInstance(PayActivity.this);
//                    boolean flag = sm.scanOpen();
//                    Log.i(TAG, "scanOpen: "+flag);
...
//                    showToast("暂不支持");
    ...
    public void sendIntent(String payWayString, String ss, String zl) {
        ...
        if (orderType == URL.ORDERTYPE_REFUND) {
            ss = String.valueOf(-Double.parseDouble(ss));
        }
        intent.putExtra(PaySuccessDialogActivity.PUT_SS, ss);
        intent.putExtra(PaySuccessDialogActivity.PUT_MTYPE ,orderType);
