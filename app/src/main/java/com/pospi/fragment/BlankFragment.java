...
//                } else {
                ...
                holder.tv_pop = (TextView) convertView.findViewById(R.id.tvPop);
//                }
...
//            }
           ...
           // holder.tv_good_price.setText("￥100.0");
            if (goodsBeens.get(position).getPopPrice() != 0) {
                holder.tv_pop.setText("促销价："+goodsBeens.get(position).getPopPrice());
                holder.tv_good_price.setText(String.format("￥%s", String.valueOf(goodsBeens.get(position).getPrice())));
            } else {
                holder.tv_pop.setText("");
                holder.tv_good_price.setText(String.format("￥%s", String.valueOf(goodsBeens.get(position).getPrice())));
            }
