...
//    public final static int xinyongka = 8;
    ...
    public final static String XJ = "现金支付";
    ...
    public final static String LNK = "老年卡";
    public final static String ZP = "支票支付";
    public final static int  pay_lnk= 21;//老年卡
    public final static int pay_zp = 22;//支票支付
    //现金
