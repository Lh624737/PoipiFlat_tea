...
//    private String HOST = "http://se.pospi.com";
    private String PayHost;

    public String host() {
//        try {
//            HOST = context.getSharedPreferences("url", Context.MODE_PRIVATE).getString("url", "http://se.pospi.com");
//        } catch (NullPointerException e) {
//            HOST = "http://se.pospi.com";//http://192.7.7.172:9999
//        }
//        return "http://se.pospi.com";//测试库
        return "http://222.128.20.136:28888";//正式库
    }
...
//    public String LOGIN = host() + "/index.php/Api/Root/Login";
    public String LOGIN = host() + "/api.php?m=login&a=login";
    /**
     * 商品
     */
    public String SYNC_MENUS = host() + "/api.php?m=login&a=getGoods";
    /**
     * 收银员
     */
     ...
     * 分类
     */
    public String SYNCCATEGORY = host() + "/api.php?m=login&a=getGoodsCat";
    /**
     * 分类
     */
    public String PROMOTION = host() + "/api.php?m=login&a=getPop";
    /**
     * 单据号
     */
     ...
     * 上传订单
     */
    public String SYNCORDER = host() + "/api.php?m=login&a=saveSell";
    /**
     * 库存订单
     */
    public String SYNCORDER_KC = host() + "/api.php?m=login&a=sellCheck";

    /**
     * 店铺信息
     */
    public String SYNCSHOP = host() + "/api.php?m=login&a=getMarket";
    /**
     * 支付方式
     */
