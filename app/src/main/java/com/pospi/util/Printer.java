...
public class Printer {
    ...
    public void print(Context context, final String shishou , String payway , String maxNo, final ValueCardDto valueCardDto , final String sid , final int orderType) {
        ...
        switch (Build.MODEL) {
            ...
            case URL.MODEL_DT92:
                ...
                break;
            case URL.MODEL_T1:
                myPrinter = PrinterFactory.getSuMiPrinter(context, maxNo, payway ,sid);
                break;
        }
        ...
        for (int i = 0; i < receipt_num; i++) {
            ...
            new Thread(new Runnable() {
                @Override
                public void run() {
                    myPrinter.starPrint(goods, shishou, null, true, valueCardDto ,sid ,orderType);
                }
            }).start();
        }
    }
